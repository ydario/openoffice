...
rem *************************************************************
setlocal
SET JAVA_HOME=%UNIXROOT%\os2\java160
SET ANT_HOME=%UNIXROOT%/os2/java160/apache-ant-1.9.13
...
SET CFG_OPT=%CFG_OPT% --with-ant-home=%ANT_HOME% --without-junit
...
SET CFG_OPT=%CFG_OPT% --disable-epm
SET CFG_OPT=%CFG_OPT% --with-system-expat --with-system-hunspell
